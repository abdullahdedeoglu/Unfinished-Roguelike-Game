...
public class RoomNodeGraphEditor : EditorWindow
{
    ...
    private void CreateRoomNode(object mousePositionObject)
    {
        ...
        {
            CreateRoomNode(new Vector2(200f, 200f), roomNodeTypeList.roomNodeTypeList.Find(x => x.isEntrance));
        }

        CreateRoomNode(mousePositionObject, roomNodeTypeList.roomNodeTypeList.Find(x => x.isNone));
    }
    ...
    private void DrawRoomNodes()
    {
        foreach (RoomNodeSO roomNode in currentRoomNodeGraph.roomNodeList)
        {
            if (roomNode.isSelected)
            {
                roomNode.DrawNode(selectedRoomNodeStyle);
            }
            else
            {
                roomNode.DrawNode(roomNodeStyle);
            }
